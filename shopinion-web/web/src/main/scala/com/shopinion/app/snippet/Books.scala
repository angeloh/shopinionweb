...
import com.shopinion.app.model._
import Model._
...
class BookOps extends Loggable {
  ...
  def add (xhtml : NodeSeq) : NodeSeq = {
    ...
    bind("book", xhtml,
	 ...
	 "genre" -> SHtml.select(Genre.getNameDescriptionList, (Box.legacyNullTest(book.genre).map(_.toString) or Full("")), choice => book.genre = Genre.withName(choice)),
